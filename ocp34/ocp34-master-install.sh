#!/bin/bash
# This script file is passed as user-data to the instance to partition it with a new LVM volume for docker and to configure RHEL repositories
#
# Pass some variables
...
# Installation -> should go in ansible
